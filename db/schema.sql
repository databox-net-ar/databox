...
-- ----------------------------
-- Table structure for aws_cuentas
-- ----------------------------
DROP TABLE IF EXISTS `aws_cuentas`;
CREATE TABLE `aws_cuentas`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for aws_bases
-- ----------------------------
DROP TABLE IF EXISTS `aws_bases`;
CREATE TABLE `aws_bases`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `motor` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `estado` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '1',
...
-- ----------------------------
-- Table structure for aws_canales
-- ----------------------------
DROP TABLE IF EXISTS `aws_canales`;
CREATE TABLE `aws_canales`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for aws_servidores
-- ----------------------------
DROP TABLE IF EXISTS `aws_servidores`;
CREATE TABLE `aws_servidores`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `host` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `region` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `tipo_instancia` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `usuario_ssh` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `contrasena_ssh` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `cuenta_id` int(11) NULL DEFAULT NULL,
  `estado` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '1',
  `notas` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `actualizado` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- ----------------------------
-- Table structure for datacount_asientos_adjuntos
-- ----------------------------
-- Documentos adjuntados a un asiento contable. Metadata (nombre / cargado /
-- tipo / formato / archivo / uuid); el binario vive en S3 bajo
-- `<bucket>/datacount/asientos/<uuid>.<ext>`. Mismo patron que
-- `datacount_pagos_adjuntos`. ON DELETE CASCADE contra el asiento padre.
DROP TABLE IF EXISTS `datacount_asientos_adjuntos`;
CREATE TABLE `datacount_asientos_adjuntos` (
  `id`         int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_dcaa_asiento` FOREIGN KEY (`asiento`) REFERENCES `datacount_asientos` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `datarocket_prospectos`  (
  ...
  `whatsapp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `correo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '',
  -- Host + path SIN esquema: `www.bna.com.ar/sucursales`, nunca
...
-- ----------------------------
-- Historial UNICO de actividad del CRM Datarocket: el timeline que en
-- Salesforce es Activity, en HubSpot Engagement y en Pipedrive Activity.
-- Cada fila registra que "algo" sucedio en la `fecha` indicada, ya sea
...
--     'correo_enviado', 'correo_abierto', 'whatsapp_enviado',
--     'sms_enviado', 'link_clickeado'. Manuales / historicos:
--     'consulta_recibida' (la persona nos escribio) y 'nota'.
--   * `mensaje_id` + `origen` son una asociacion POLIMORFICA al registro
--     que origino la interaccion. `mensaje_id` guarda el ID y `origen`
--     indica en que tabla buscarlo ('aws_mensajes' / 'evolution_mensajes'
...
--   * `usuario_id` es el autor de la carga manual; NULL = lo escribio el
--     sistema. Sin FK a `usuarios`: ninguna tabla del schema la tiene.
...
-- ----------------------------
-- Table structure for datarocket_mensajes
-- ----------------------------
DROP TABLE IF EXISTS `datarocket_mensajes`;
CREATE TABLE `datarocket_mensajes`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uuid` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `fecha` datetime(0) NULL DEFAULT NULL,
  `campana` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for datarocket_plantillas
-- ----------------------------
DROP TABLE IF EXISTS `datarocket_plantillas`;
CREATE TABLE `datarocket_plantillas`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `slug` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `proyecto_id` int(11) NULL DEFAULT NULL,
  `medio` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `remitente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `adjunto` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `adjunto_origen` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_dr_plantillas_proyecto`(`proyecto_id`) USING BTREE,
  CONSTRAINT `fk_dr_plantillas_proyecto` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 17640 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for evolution_canales
-- ----------------------------
DROP TABLE IF EXISTS `evolution_canales`;
CREATE TABLE `evolution_canales`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for evolution_vetados
-- ----------------------------
DROP TABLE IF EXISTS `evolution_vetados`;
CREATE TABLE `evolution_vetados`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fecha` datetime(0) NULL DEFAULT NULL,
  `destino` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `error` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for evolution_mensajes
-- ----------------------------
...
CREATE TABLE `localidades`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_localidades_pais`(`pais_id`) USING BTREE,
  INDEX `idx_localidades_provincia`(`provincia_id`) USING BTREE,
  CONSTRAINT `fk_localidades_pais` FOREIGN KEY (`pais_id`) REFERENCES `paises` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_localidades_provincia` FOREIGN KEY (`provincia_id`) REFERENCES `provincias` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `claro_sims`  (
  ...
  `consumo_datos` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `provincias`  (
  ...
  `propagacion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_provincias_pais`(`pais_id`) USING BTREE,
  CONSTRAINT `fk_provincias_pais` FOREIGN KEY (`pais_id`) REFERENCES `paises` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
