-- Crea `datacount_clientes` — catálogo transversal (multiempresa) de
-- clientes de Datacount. Los clientes NO están asociados a una
-- `datacount_empresas` en particular: el mismo cliente puede facturarse
-- desde cualquiera de las empresas administradas por Datacount.
--
-- Cada fila reúne datos identificatorios (nombre, razón social,
-- condición fiscal AFIP, CUIT), de contacto (domicilio, celular,
-- correo, web) y bancarios (CBU).
--
...
CREATE TABLE IF NOT EXISTS `datacount_clientes` (
